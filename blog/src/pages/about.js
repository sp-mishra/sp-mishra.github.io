      ...
      <div className="post-page-main">
        ...
        <div className="post-main">
          ...
          <div className="mt-3">
            ...
            <p><i>Developer Diary for BrainlessLabs.</i></p>
            <br/>
            <h4>Features</h4>
            <div>
            ...
            <div className="mt-4">
              ...
              <p className="d-inline-block ml-3 w-75 align-top">Includes Prism for code block styling in markdown
                files</p>
            </div>
            <div>
              ...
              <p className="d-inline-block ml-3 w-75 align-top">Developer-relevant social-media icon links including
                GitHub, Stack Overflow and freeCodeCamp</p>
            </div>
            <div>
